<template>
  ...
  >
    ...
    <path
      fill="#D9E2EC"
      d="M69.1200097 135.48970725l427.2948351-91.68208277 126.67492385 590.38297406-427.2948351 91.68208278z"
    />
    <path
      transform="rotate(-12.11 160.03024298 1309.79665023)"
      fill="url(#a)"
    ...
    <path
      fill="#F0F4F8"
      d="M84.63850388 146.99341557l402.34274093-86.328262L606.6701878 618.48916464l-402.34274093 86.328262z"
    />
    <path
      transform="rotate(-12.11 100.28072504 1028.70675856)"
      fill="url(#b)"
    ...
    <path
      fill="#2bb0ed"
      d="M183.0070188 98.42188668l195.39288784-41.92427674 9.9167362 46.2180835-195.39288785 41.92427675z"
    />
    <path
    ...
    <path
      ...
      fill="url(#f)"
    />
    <path fill="#2bb0ed" d="M377.02 104.56h199.84v47.27H377.02z" />
    <path
    ...
    <path
      ...
      opacity=".5"
    />
    <circle cx="812.64" cy="314.47" r="7.53" fill="#F86A6A" opacity=".5" />
    <circle cx="230.73" cy="746.65" r="7.53" fill="#F86A6A" opacity=".5" />
    <circle cx="735.31" cy="477.23" r="7.53" fill="#F86A6A" opacity=".5" />
    <circle cx="87.14" cy="96.35" r="7.53" fill="#1992D4" opacity=".5" />
    <circle cx="7.53" cy="301.76" r="7.53" fill="#65D6AD" opacity=".5" />
  </svg>
</template>
...
export default class NoData extends Vue {
  @Prop({ type: [Number, String], default: 150 }) private width!:
    | number
    | string;
}
</script>
